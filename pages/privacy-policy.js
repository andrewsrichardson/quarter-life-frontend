    ...
    <>
      ...
      <Container>
        <div className="bg-white p-24 outline">
          <h1 class="text-center text-2xl m-10">Privacy Policy</h1>

          <p>
            <strong>Effective Date: 10-10-2020</strong>
          </p>
          ...
          <p>
            ...
            ad server to recognise your computer each time they send you an
          ...
          <h2 id="Credit">11. Contact Information &amp; Credit</h2>
          <p>
